...
- delivery
```
 http :8088/deliveries id="id"orderId="orderId"customerId="customerId"productId="productId"status="status"address="address"qty="qty"
```
- inventory
```
 http :8088/inventories id="id"name="name"
```
